  ...
  return (
    <>
      <Button
        ...
        className="fixed top-4 right-4 z-10 hover:bg-transparent text-black dark:text-white"
        size="icon"
        variant="ghost"
      >
      ...
      {isMenuOpen && (
        <div className="fixed top-16 right-4 bg-white/80 dark:bg-black/80 backdrop-blur-sm rounded-lg shadow-lg z-20 min-w-[200px] py-2 ring-1 ring-black/10 dark:ring-white/20">
          <div className="w-full px-4 py-2 flex items-center justify-between text-black dark:text-white border-b border-gray-200 dark:border-gray-800">
          ...
          {onSettingsClick && (
            <button
              ...
              className="w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-800 text-black dark:text-white flex items-center gap-2"
            >
