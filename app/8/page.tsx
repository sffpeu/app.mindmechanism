    ...
    <ProtectedRoute>
      ...
      <div className="h-full overflow-x-hidden flex flex-col bg-gray-50 dark:bg-black/95 min-h-0">
        ...
        <div className={cn("fixed bottom-4 left-4 z-50 flex items-center gap-2 transition-opacity duration-700", isIdle && "opacity-0 pointer-events-none")}>
          ...
          <DraggableClockPanel open={isInfoOpen} onClose={() => setIsInfoOpen(false)} clockHex={clockHex} clockIndex={8} instanceId="info-8" panelWidth="300px">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 pb-3 border-b border-black/10 dark:border-white/10 text-center">
                      ...
                      <p className="text-xs text-black/60 dark:text-white/60 line-clamp-2">
                        {CLOCK_INDEX === 8 ? 'The foundational anchor point of the system, representing the integration of consciousness into the physical world.' : 'The foundational anchor point of the system, representing the integration of consciousness into the physical world.'}
                      </p>
                    </div>
