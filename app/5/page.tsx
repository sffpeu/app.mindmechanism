...
function NodesPageContent() {
  ...
  const getFocusNodeStyle = (index: number, isSelected: boolean) => {
    const color = '#941952' // Dot menu hover color for clock 5 (dark pink)
    return {
  ...
  const clockColor = hexToRgb('#941952') // Dot menu color for clock 5 (dark pink)
