    ...
    <ProtectedRoute>
      ...
      <div className="h-full overflow-x-hidden flex flex-col bg-gray-50 dark:bg-black/95 min-h-0">
        ...
        <div className={cn("fixed top-4 right-14 z-[200] transition-opacity duration-700", isIdle && "opacity-0 pointer-events-none")}>
          ...
          <DraggableClockPanel open={isDropdownOpen} onClose={() => setIsDropdownOpen(false)} clockHex={clockHex} clockIndex={0}>
              <ClockPanelRow>
        ...
        <div className={cn("fixed bottom-4 left-4 z-50 flex items-center gap-2 transition-opacity duration-700", isIdle && "opacity-0 pointer-events-none")}>
          ...
          <DraggableClockPanel open={isInfoOpen} onClose={() => setIsInfoOpen(false)} clockHex={clockHex} clockIndex={0} instanceId="info-0" panelWidth="300px">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 pb-3 border-b border-black/10 dark:border-white/10 text-center">
                      ...
                      <p className="text-xs text-black/60 dark:text-white/60">
                        {clock0.startDateTime.getDate().toString().padStart(2, '0')}.{(clock0.startDateTime.getMonth() + 1).toString().padStart(2, '0')}.{clock0.startDateTime.getFullYear()}
                      </p>
          ...
          <div className="relative w-[82vw] h-[82vw] max-w-[615px] max-h-[615px] overflow-visible" onPointerMove={resetNodeNumberTimer} onPointerDown={resetNodeNumberTimer}>
            ...
            <div className="absolute inset-0 rounded-full overflow-hidden">
              ...
              >
                ...
                >
                  <Image 
                    src={colourMode === 'colour' ? '/clock_1_colour.svg' : clock0.imageUrl}
                    alt="Clock Face 0"
                    layout="fill"
                    objectFit="cover"
            ...
            >
              <div className="absolute inset-0 pointer-events-none" style={{ transform: `rotate(${clock0.imageOrientation}deg)` }}>
        ...
        {mounted && selectedWord && cardPosition && typeof document !== 'undefined' && createPortal(
          ...
          >
            {(() => {
              ...
              const sent = getSentimentStyles(gw?.rating)
              return (
                <>
                  <div
                    className="p-4 pb-2 pr-10 cursor-grab active:cursor-grabbing select-none"
                  ...
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); setSelectedWord(null); setGlossaryOpenForNode(null) }}
        ...
        {/* Timer and progress bar at the very bottom so they never interfere with focus node clicks */}
